...
public class Delivery{
    ...
    private ArrayList<Consegna> consegne = new ArrayList<>();
    ...
    public void confermaOrdine() {
        ...
        double totale = sumCart();
        Consegna nuova = new Consegna(client, cart.get(0).getRestaurant(), totale);
        consegne.add(nuova);
        client.setSaldo(client.getSaldo() - (int)totale);
        cart.clear();
    }

    public ArrayList<Consegna> getConsegne(){return consegne;}
    ...
    public ArrayList<Prodotto> getCart() {
        return cart;
    }
